...
public class DownLoadingApkUtil {
    ...
    private String downLoadFile = SDCardUtils.getSDCardPath() + "/huduoduo/"; //下载的文件地址

    private Dialog noticeDialog;// 提示有软件更新的对话框

    private Dialog downloadDialog;// 下载对话框

    private final String saveFileName = downLoadFile + "huduoduo.apk";
    ...
    private String apkUrl = CMD.DOWNLOADAPK_PATH; // 网络下载路径
    
    private TextView progress_txt;


    public DownLoadingApkUtil(Context context) {
