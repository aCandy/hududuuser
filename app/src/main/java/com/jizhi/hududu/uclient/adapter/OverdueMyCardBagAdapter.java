 ...
 */
public class OverdueMyCardBagAdapter extends BaseAdapter {
	private Context context;
	private List<MyCardBag> list;
	private LayoutInflater inflater;

	public OverdueMyCardBagAdapter(Context context,List<MyCardBag> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.image_card_type.setImageResource(R.drawable.qie_over);
		String modeType = card.getModetype();
		String[] descs = card.getDesc();
		holder.term_of_validity.setTextColor(context.getResources().getColor(R.color.card_money_gray));
		holder.unit.setTextColor(context.getResources().getColor(R.color.card_money_gray));
		holder.price.setTextColor(context.getResources().getColor(R.color.card_money_gray));
